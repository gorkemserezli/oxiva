              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@oxiva.com</p>
                    <p className="text-sm text-gray-500">24 saat içinde dönüş</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">0XXX XXX XX XX</p>
                    <p className="text-sm text-gray-500">Hızlı destek için</p>
                  </div>
                </div>
            ...
            >
              <div className="bg-gray-50 rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="kargo">Kargo Takibi</option>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white py-3 rounded-lg hover:from-primary-600 hover:to-primary-700 transition-all font-semibold"
                  >
                    Mesaj Gönder
                  </button>
                </form>
